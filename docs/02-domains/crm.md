...
## Security
All private CRM endpoints require JWT + existing AuthorizationGuard permissions. Public intake has a dedicated unauthenticated boundary and remains protected by the global rate limiter. PII is serialized explicitly; provider secrets and tokens are never accepted or persisted.
