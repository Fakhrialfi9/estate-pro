...
export interface NotificationPreferenceContract { readonly uuid: string; readonly userUuid: string; readonly notificationType: string; readonly channel: NotificationChannelContract; readonly enabled: boolean; readonly createdAt: Date; readonly updatedAt: Date; }
export interface NotificationTemplateContract { readonly uuid: string; readonly code: string; readonly version: number; readonly titleTemplate: string; readonly bodyTemplate: string; readonly variables: readonly string[]; readonly isActive: boolean; readonly createdAt: Date; readonly updatedAt: Date; }
export interface NotificationPolicyContract { readonly uuid: string; readonly notificationUuid: string; readonly templateUuid: string | null; readonly priority: NotificationPriorityContract; readonly expiresAt: Date | null; readonly createdAt: Date; readonly updatedAt: Date; }
