...
@Module({
  ...
  providers: [
    ...
    { provide: REFRESH_TOKEN_FAMILY_REPOSITORY, useExisting: REFRESH_TOKEN_REPOSITORY },
    { provide: REFRESH_TOKEN_SECURITY_PORT, useExisting: REFRESH_TOKEN_REPOSITORY },
    ...
    { provide: TWO_FACTOR_ENROLLMENT_REPOSITORY, useClass: PrismaTwoFactorEnrollmentRepository },
