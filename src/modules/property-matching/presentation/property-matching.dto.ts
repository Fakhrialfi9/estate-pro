...
type FurnishedStatus = NonNullable<
  NonNullable<PropertyPreferenceState['specification']>['furnishedStatus']
>;
type PropertyCondition = NonNullable<
  NonNullable<PropertyPreferenceState['specification']>['condition']
>;
type PriceFrequency = NonNullable<
  PropertyPreferenceState['budget']
>['frequency'];
...
class LocationPreferenceDto {
  ...
  @ApiPropertyOptional({ minimum: 0.1, maximum: 500 })
  @IsOptional()
  @IsNumber()
  @Min(0.1)
  @Max(500)
...
class BudgetPreferenceDto {
  ...
  @ApiProperty({ enum: ['TOTAL', 'PER_MONTH', 'PER_YEAR', 'PER_DAY'] })
  @IsEnum(['TOTAL', 'PER_MONTH', 'PER_YEAR', 'PER_DAY'])
...
class SpecificationPreferenceDto {
  @ApiPropertyOptional({ type: IntRangeDto })
  @IsOptional()
  @ValidateNested()
  @Type(() => IntRangeDto)
  bedrooms?: IntRangeDto;
  @ApiPropertyOptional({ type: DecimalRangeDto })
  @IsOptional()
  @ValidateNested()
  @Type(() => DecimalRangeDto)
  bathrooms?: DecimalRangeDto;
  @ApiPropertyOptional({ type: DecimalRangeDto })
  @IsOptional()
  @ValidateNested()
  @Type(() => DecimalRangeDto)
  areaSqm?: DecimalRangeDto;
  @ApiPropertyOptional({ type: IntRangeDto })
  @IsOptional()
  @ValidateNested()
  @Type(() => IntRangeDto)
  parkingSpaces?: IntRangeDto;
  @ApiPropertyOptional({
  ...
  @ApiPropertyOptional({
    enum: ['NEW', 'GOOD', 'FAIR', 'NEEDS_RENOVATION', 'RENOVATED'],
  })
  @IsOptional()
  @IsEnum(['NEW', 'GOOD', 'FAIR', 'NEEDS_RENOVATION', 'RENOVATED'])
  condition?: PropertyCondition;
}
export class PreferenceDto {
  @ApiProperty({ enum: MATCHING_SUBJECT_TYPES })
  @IsEnum(MATCHING_SUBJECT_TYPES)
  ...
  @IsArray()
  @ArrayUnique()
  @IsEnum(['SALE', 'RENT', 'LEASE', 'AUCTION', 'JOINT_VENTURE', 'OTHER'], {
    each: true,
  })
  ...
  @ArrayUnique()
  @IsUUID('4', { each: true })
  propertyTypeUuids!: string[];
  @ApiProperty({ type: String, isArray: true })
  @IsArray()
  @ArrayUnique()
  @IsUUID('4', { each: true })
  propertyCategoryUuids!: string[];
  @ApiPropertyOptional({ type: LocationPreferenceDto })
  @IsOptional()
  @ValidateNested()
  @Type(() => LocationPreferenceDto)
  location?: LocationPreferenceDto;
  @ApiPropertyOptional({ type: BudgetPreferenceDto })
  @IsOptional()
  @ValidateNested()
  @Type(() => BudgetPreferenceDto)
  budget?: BudgetPreferenceDto;
  @ApiPropertyOptional({ type: SpecificationPreferenceDto })
  @IsOptional()
  @ValidateNested()
  @Type(() => SpecificationPreferenceDto)
  specification?: SpecificationPreferenceDto;
  @ApiProperty({ enum: HARD_CRITERIA, isArray: true })
  @IsArray()
  @ArrayUnique()
  @IsEnum(HARD_CRITERIA, { each: true })
  hardCriteria!: HardCriterion[];
}
...
export class MatchQueryDto {
  @ApiPropertyOptional({ minimum: 0, maximum: 100, default: 35 })
  @IsOptional()
  @Type(() => Number)
  @IsNumber()
  @Min(0)
