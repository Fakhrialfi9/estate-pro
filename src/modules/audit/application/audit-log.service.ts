...
import type { AuditLogListQuery, AuditLogListResult, AuditLogRepository, AuditLogWriteEvent } from '../domain/repositories/audit-log.repository.js';
import type { SecurityAuditRepository, SecurityAuditEvent } from '../../../common/audit/security-audit.port.js';
import { sanitizeAuditChanges, sanitizeAuditReason } from '../../../common/audit/audit-redaction.js';
