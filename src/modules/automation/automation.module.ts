...
import { AutomationNotificationScheduler } from './infrastructure/scheduler/automation-notification.scheduler.js';
...
@Module({
  ...
  providers: [
    ...
    AutomationNotificationScheduler,
    ...ACTION_HANDLERS,
    ...
    AutomationScheduler,
    {
      ...
      useFactory: (scheduler: AutomationScheduler): AutomationHealthPort => ({
        check: () => Promise.resolve(scheduler.isHealthy() ? 'up' : 'down'),
      }),
    },
  ],
  exports: [
