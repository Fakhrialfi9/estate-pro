  ...
  it('keeps the public detail contract stable and excludes sensitive fields', () => {
    const result = mapPropertyDetail(
      {
        ...
        financial: { uuid: 'fin', askingPrice: 'SECRET', negotiable: true },
        media: [],
        agentAssignments: [],
        owner: {
          uuid: 'owner',
          ownerType: 'INDIVIDUAL',
          displayNameMasked: 'Mu****in',
          companyNameMasked: 'PRIVATE CO',
        },
        features: null,
        security: null,
        environment: null,
    ...
    expect(result).toMatchObject({
      ...
      listing: {
        ...
        status: 'PUBLISHED',
        visibility: 'PUBLIC',
        price: { currency: 'IDR', min: '1000000.00' },
      },
      owner: {
        uuid: 'owner',
        ownerType: 'INDIVIDUAL',
