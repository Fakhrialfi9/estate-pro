...
const toUpdate = (dto: UpdateListingDto): UpdateListingInput => ({
  ...(dto.listingCode !== undefined ? { listingCode: dto.listingCode } : {}),
...
export class ListingController {
  ...
  create(
    ...
    return this.service
      ...
      .then((data) => ({ data: mapListingResponse(data) }));
  }
  @Get('listings')
  ...
  assignAgent(
    ...
    return this.service
      ...
      .then((data) => ({ data: mapAgentAssignment(data) }));
  }
  ...
  assignOwner(
    ...
    return this.service
      ...
      .then((data) => ({ data: mapOwnerResponse(data) }));
  }
}
