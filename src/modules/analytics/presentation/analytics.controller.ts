...
} from '../domain/policies/analytics-scope.policy.js';
...
export class AnalyticsController {
  ...
  @Get('acquisition')
  @ApiOperation({
    summary: 'Source and campaign analytics',
    description:
  ...
  @Get('property-agent')
  @ApiOperation({
    summary: 'Property and agent analytics',
    description:
  ...
  @ApiOperation({
    summary: 'CSV analytics export',
    description:
      'Bounded export of a supported analytics report using the same authorization scope.',
  })
  @ApiQuery({
    name: 'report',
    required: true,
