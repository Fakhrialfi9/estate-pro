...
export class AnalyticsController {
  ...
  @Get('property-agent')
  @ApiOperation({ summary: 'Property and agent analytics', description: 'Property inventory, listing, lifecycle, workload, activity, conversion and scorecard metrics.' })
  ...
  @Get('sla')
  @ApiOperation({ summary: 'SLA analytics', description: 'Response and qualification SLA reporting.' })
  ...
  @ApiOperation({ summary: 'Forecast analytics', description: 'Deterministic baseline using historical average and weighted open pipeline.' })
  ...
  @ApiOperation({ summary: 'CSV analytics export', description: 'Bounded export of a supported analytics report using the same authorization scope.' })
