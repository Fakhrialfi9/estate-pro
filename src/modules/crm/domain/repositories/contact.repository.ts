import type { ContactEntity, ContactPatch, ContactProps } from '../entities/contact.entity.js';
import type { PageQuery, PageResult } from '../../application/ports/page-query.port.js';

export interface ContactRepository {
  create(props: Omit<ContactProps, 'uuid'|'createdAt'|'updatedAt'>): Promise<ContactEntity>;
