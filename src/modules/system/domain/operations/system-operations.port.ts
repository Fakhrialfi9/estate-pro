import type { SystemOperationalDiagnostics, SystemOperationalState } from './system-operations.contracts.js';
...
export interface SystemOperationsPort {
  ...
  setMaintenance(actorUuid: string, enabled: boolean): Promise<SystemOperationalState>;
  setReadOnly(actorUuid: string, enabled: boolean): Promise<SystemOperationalState>;
