...
export const configurationValidationSchema = Joi.object({
  ...
  TWO_FACTOR_CHALLENGE_TTL_MS: Joi.number()
    .integer()
    .min(30000)
    .max(900000)
    .default(300000),
  TWO_FACTOR_CHALLENGE_MAX_ATTEMPTS: Joi.number()
    .integer()
    .min(3)
    .max(10)
    .default(5),
  TWO_FACTOR_OTP_LOCKOUT_THRESHOLD: Joi.number()
    .integer()
    .min(2)
    .max(20)
    .default(5),
  TWO_FACTOR_OTP_LOCKOUT_DURATION_MS: Joi.number()
    .integer()
    .min(60000)
    .max(86400000)
    .default(900000),
  TWO_FACTOR_RECOVERY_CODE_COUNT: Joi.number()
    .integer()
    .min(5)
    .max(20)
    .default(10),
  ...
  AUTH_REFRESH_RATE_LIMIT_TTL_MS: Joi.number()
    .integer()
    .min(1000)
    .max(3600000)
    .default(60000),
  AUTOMATION_POLL_INTERVAL_MS: Joi.number()
    .integer()
    .min(100)
    .max(60000)
    .default(1000),
  AUTOMATION_LEASE_MS: Joi.number()
    .integer()
    .min(1000)
    .max(900000)
    .default(30000),
  AUTOMATION_ACTION_TIMEOUT_MS: Joi.number()
    .integer()
    .min(100)
    .max(300000)
    .default(30000),
  AUTOMATION_WORKFLOW_MAX_DURATION_MS: Joi.number()
    .integer()
    .min(1000)
    .max(3600000)
    .default(300000),
  AUTOMATION_WORKFLOW_MAX_DEPTH: Joi.number()
    .integer()
    .min(1)
    .max(100)
    .default(20),
  ...
  AUTOMATION_ACTION_RATE_LIMIT: Joi.number()
    ...
    .max(10000)
    .default(100),
  AUTOMATION_ACTION_RATE_WINDOW_MS: Joi.number()
    .integer()
    .min(1000)
    .max(3600000)
    .default(60000),
  AUTOMATION_SCHEDULER_BATCH_SIZE: Joi.number()
    .integer()
    .min(1)
    .max(1000)
    .default(25),
  ...
  SYSTEM_EXPORT_RETENTION_HOURS: Joi.number()
    ...
    .max(720)
    .default(24),
  SYSTEM_RETENTION_INTERVAL_MS: Joi.number()
    .integer()
    .min(60000)
    .max(86400000)
    .default(3600000),
  SYSTEM_ACTIVITY_RETENTION_DAYS: Joi.number()
    .integer()
    .min(1)
    .max(3650)
    .default(90),
  SYSTEM_AUDIT_RETENTION_DAYS: Joi.number()
    .integer()
    .min(1)
    .max(3650)
    .default(365),
  SYSTEM_RETENTION_BATCH_SIZE: Joi.number()
    .integer()
    .min(1)
    .max(1000)
    .default(250),
  ...
  SYSTEM_WEBHOOK_RETENTION_DAYS: Joi.number()
    ...
    .max(3650)
    .default(30),
  SYSTEM_WEBHOOK_RATE_LIMIT: Joi.number()
    .integer()
    .min(1)
    .max(10000)
    .default(60),
  SYSTEM_WEBHOOK_RATE_WINDOW_MS: Joi.number()
    .integer()
    .min(1000)
    .max(3600000)
    .default(60000),
  ...
  CRM_COMMUNICATION_PROVIDER_TIMEOUT_MS: Joi.number()
    .integer()
    .min(250)
    .max(60000)
    .default(10000),
